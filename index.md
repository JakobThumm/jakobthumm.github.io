...
classes: wide
---
I'm the CTO of [scaledrive.ai](https://www.scaledrive.ai/), where we develop provably safe physical AI for industrial robots.
Prior to founding scaledrive.ai, I was a postdoctoral scholar at Stanford University in the [Autonomous Systems Lab](https://stanfordasl.github.io/) under supervision of [Marco Pavone](https://profiles.stanford.edu/marco-pavone).
I earned my Ph.D. in Computer Engineering from the Technical University of Munich with highest distinction, where I was supervised by [Matthias Althoff](https://www.ce.cit.tum.de/en/cps/members/prof-dr-ing-matthias-althoff/).

My work enables robots to work together with humans in a safe, efficient, and enjoyable manner. 
