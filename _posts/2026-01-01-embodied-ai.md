...
## Research Vision
I develop theoretical methods to enhance policy performance and generalization in safety-critical, dynamic, and collaborative settings involving human interaction.
Concretely, to achieve a more structured approach for policy generalization, I develop explainable AI methods to determine which input features cause a model to underperform in out-of-distribution situations. Building on these explanations, I aim to automatically generate training data that reflects diverse human behaviors and leverage transfer from human collaboration data.
To steer data collection toward personalized policies that minimize physical and mental burden in shared tasks, I build on my previous work in learning-based human-robot collaboration. Finally, I develop provably safe RL methods that guide policy training toward high performance in safety-critical environments.
